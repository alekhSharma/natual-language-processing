...
app.get('/', async (req, res) => {
    try {
		...
		setTimeout(function afterTwoSeconds() {
			...
			//console.log(textFromSfdc);
			let natural = require('natural');
			var classifier = new natural.BayesClassifier();
			var trainingData = [{text:'Surveys',label:'a066A0000023sF0QAI'},{text:'Omni Channel/Queue/Routing setup',label:'a066A0000023sF4QAI'},
			...
			const updateresult = client.query('UPDATE salesforce.CTSESTXCHANGE__HerokuTest__c SET salesforce.CTSESTXCHANGE__ResultSet__c = resultarry[1] WHERE salesforce.CTSESTXCHANGE__Title__c = resultarry[0]');
...
function foo(req, res){
	...
	var trainingData = [
	{text:'Surveys',label:'a066A0000023sF0QAI'	},
